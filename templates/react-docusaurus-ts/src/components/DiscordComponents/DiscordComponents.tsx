...
import styles from './DiscordComponents.module.css';
...
function DiscordComponents() {
	return (
		<div>
			...
			<div>
				...
				<div>
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						href="https://github.com/skyra-project/discord-components-implementations/blob/main/templates/react-docusaurus-ts/src/components/DiscordComponents/DiscordComponents.tsx"
					>
						here
					</a>
					.
			...
			<main>
				<h3 className={styles.title}>A normal conversation</h3>
				<DiscordMessages>
				...
				<h3 className={styles.title}>The different kind of mentions</h3>
				<DiscordMessages>
					<DiscordMessage author="Alyx Vargas">
				...
				<h3 className={styles.title}>Light mode</h3>
				...
				<h3 className={styles.title}>Compact mode</h3>
				...
				<h3 className={styles.title}>With subsequent messages</h3>
				<DiscordMessages>
				...
				<h3 className={styles.title}>With subsequent messages and compact mode</h3>
				...
				<h3 className={styles.title}>Markdown Styling</h3>
				<DiscordMessages>
				...
				<h3 className={styles.title}>No Background mode</h3>
				...
				<DiscordMessages>
					<DiscordMessage profile="maximillian">
						Hey, <DiscordMention>Alyx Vargas</DiscordMention> and <DiscordMention>Dawn</DiscordMention>. Welcome to our server! Be sure to
						read through the <DiscordMention type="channel">rules</DiscordMention>. You can ping
						<DiscordMention type="role" color="#70f0b4">
							Support
						</DiscordMention>
				...
				<h3 className={styles.title}>Custom Discord Emojis</h3>
				<DiscordMessages>
					<DiscordMessage profile="favna">
				...
				<h3 className={styles.title}>Server Invites</h3>
				<DiscordMessages>
					<DiscordMessage profile="favna">
						discord.gg/djs <br />
						discord.gg/code <br />
				...
				<h3 className={styles.title}>Image Attachments with small images</h3>
				<DiscordMessages>
					<DiscordMessage author="Alyx Vargas">
				...
				<h3 className={styles.title}>Image Attachments with custom image components (you can see this in the code only)</h3>
				<DiscordMessages>
					<DiscordMessage profile="favna">
				...
				<h3 className={styles.title}>Image Attachments with large images</h3>
				<DiscordMessages>
					<DiscordMessage profile="favna">
				...
				<h3 className={styles.title}>File Attachments</h3>
				<DiscordMessages>
					<DiscordMessage profile="favna">
				...
				<h3 className={styles.title}>Audio attachments</h3>
				<DiscordMessages>
					<DiscordMessage profile="favna">
				...
				<h3 className={styles.title}>Video attachments</h3>
				<DiscordMessages>
					<DiscordMessage profile="favna">
						Look at this video!
						<DiscordVideoAttachment
				...
				<h3 className={styles.title}>System Messages</h3>
				<DiscordMessages>
					...
					<DiscordSystemMessage type="join">
						<i>Snazzah</i> has added <i>Discord Developers #DiscordApiAnnouncements</i> to this channel. Its most important updates will
						show up here.
					</DiscordSystemMessage>
				...
				<h3 className={styles.title}>Reactions</h3>
				<DiscordMessages>
					<DiscordMessage profile="favna">
				...
				<h3 className={styles.title}>Replies</h3>
				<DiscordMessages>
					<DiscordMessage profile="favna">
				...
				<h3 className={styles.title}>Replies in Compact Mode</h3>
				<DiscordMessages compactMode>
					<DiscordMessage profile="favna">
						<DiscordReply slot="reply" profile="skyra" edited attachment>
							What do you think about this image?
				...
				<h3 className={styles.title}>Commands with deleted message</h3>
				<DiscordMessages>
					<DiscordMessage profile="skyra">
				...
				<h3 className={styles.title}>Commands in Compact Mode</h3>
				<DiscordMessages compactMode>
					<DiscordMessage profile="skyra">
						<DiscordCommand slot="reply" profile="favna" command="/ping"></DiscordCommand>
						Pong!
				...
				<h3 className={styles.title}>Verified Discord bots</h3>
				<DiscordMessages>
					<DiscordMessage profile="skyra"> Wow I just got verified! </DiscordMessage>
				</DiscordMessages>

				<h3 className={styles.title}>Full embed example</h3>
				<DiscordMessages>
					<DiscordMessage profile="skyra">
						<DiscordEmbed
							slot="embeds"
				...
				<h3 className={styles.title}>Server crosspost messages</h3>
				<DiscordMessages>
				...
				<h3 className={styles.title}>Embedded video</h3>
				<DiscordMessages>
					<DiscordMessage profile="skyra">
						<DiscordEmbed
							slot="embeds"
				...
				<h3 className={styles.title}>Embed fields</h3>
				<DiscordMessages>
					<DiscordMessage profile="skyra">
				...
				<h3 className={styles.title}>A tenor-gif in video format</h3>
				<DiscordMessages>
					<DiscordMessage profile="maximillian">
				...
				<h3 className={styles.title}>Inline fields</h3>
				<DiscordMessages>
					<DiscordMessage profile="skyra">
						<DiscordEmbed slot="embeds">
							<DiscordEmbedFields slot="fields">
				...
				<h3 className={styles.title}>Inline fields with a thumbnail</h3>
				<DiscordMessages>
					<DiscordMessage profile="skyra">
						<DiscordEmbed
							slot="embeds"
				...
				<h3 className={styles.title}>Ordered list items</h3>
				<DiscordMessages>
					<DiscordMessage profile="favna">
						<DiscordOrderedList>
				...
				<h3 className={styles.title}>Unordered list items</h3>
				<DiscordMessages>
					<DiscordMessage profile="favna">
						<DiscordUnorderedList>
