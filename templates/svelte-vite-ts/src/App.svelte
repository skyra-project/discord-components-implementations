		...
		<div>
			...
			<div>
				...
				<a
					...
					target="_blank"
					rel="noopener noreferrer"
					href="https://github.com/skyra-project/discord-components-implementations/blob/main/templates/svelte-vite-ts/src/App.svelte"
					>here</a
				>.
			</div>
		</div>
		...
		<main id="demo">
			...
			<discord-messages>
				...
				<discord-message profile="favna" message-body-only timestamp="12:40"
					>Just keep in mind that Discord does some funky stuff like with time between messages, this library doesn't automatically change
					what is displayed!</discord-message
				>
			</discord-messages>
			...
			<discord-messages>
				...
				<discord-system-message type="join">
					<i>Snazzah</i> has added <i>Discord Developers #discord-api-announcements</i> to this channel. Its most important updates will show
					up here.
				</discord-system-message>
					...
					<discord-attachments slot="components">
						<discord-action-row>
							...
							<discord-button
								url="https://join.skyra.pw"
								emoji="https://raw.githubusercontent.com/skyra-project/discord-components-implementations/main/shared/public/eyes.svg"
								emoji-name="👀">Link</discord-button
							>
						</discord-action-row>
						<discord-action-row>
				...
				<discord-message profile="skyra">
					...
					>
						<discord-embed-description slot="description">
							...
							bot framework.
							<br /><br />Sapphire is a community driven framework that aims to give you all the features you need to make your Discord
							bot.<br /><br />With a history of many other Discord bot frameworks (both for NodeJS and other languages) to inspire
							Sapphire, it has become the ultimate modern experience of writing your code.
						</discord-embed-description>
						<discord-embed-fields slot="fields">
			...
			<discord-messages>
				<discord-message profile="discordjs" timestamp="28/01/2024">
					...
					<br />
					<br />
					You're most likely using a cached version of the old website because of our service worker, so make sure to clear your cache and any
					cookies/service workers you have. For some of you nothing needs to be done, for others a so called "hard-refresh" will do the trick
					too.
					<br />
					<br />
			...
			<discord-messages>
				<discord-message profile="skyra">
					...
					>
						<discord-embed-fields slot="fields">
							<discord-embed-field field-title="Inline field title" inline inline-index={1}> Some value 1 here </discord-embed-field>
							<discord-embed-field field-title="Inline field title" inline inline-index={2}> Some value 3 here </discord-embed-field>
							<discord-embed-field field-title="Inline field title" inline inline-index={3}> Some value 2 here </discord-embed-field>
						</discord-embed-fields>
					</discord-embed>
				</discord-message>
			</discord-messages>
